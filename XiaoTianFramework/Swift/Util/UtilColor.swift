...
open class UtilColor: NSObject{
    ...
    open var primaryColor: UIColor{
        return UIColor(red: 30/255.0, green: 139/255.0, blue: 61/255.0, alpha: 1)
    }
    /// 深主题色
    open var primaryColorDeep: UIColor {
        return UIColor(red: 39/255.0, green: 148/255.0, blue: 70/255.0, alpha: 1)
    }
    /// Tab 默认颜色
    ...
    open var redColor: UIColor{
        return UIColor(red: 251/255.0, green: 42/255.0, blue: 115/255.0, alpha: 1)
    }
    /// 深红色
    ...
    open var grayClockOnClick: UIColor{
        return UIColor(red: 208/255.0, green: 208/255.0, blue: 208/255.0, alpha: 9.8)
    }
    /// 分隔器灰色
    open var separatorColor: UIColor{
        return UIColor(red: 188/255.0, green: 186/255.0, blue: 193/255.0, alpha: 1)
    }
    /// 选择器灰色
    open var selectorColor: UIColor{
        return UIColor(red: 208/255.0, green: 208/255.0, blue: 208/255.0, alpha: 1)
    }
    /// 文本黑色
    ...
    open var textRed: UIColor{
        return UIColor(red: 252/255.0, green: 45/255.0, blue: 129/255.0, alpha: 1)
    }
    /// 文本白
    ...
    open var imageLoadingGray: UIColor{
        return UIColor(red: 239/255.0, green: 239/255.0, blue: 239/255.0, alpha: 0.9)
    }
    /// 透明
    ...
    public var randomColor: UIColor{
        ...
        return UIColor(red: CGFloat(r)/255.0, green: CGFloat(g)/255.0, blue: CGFloat(b)/255.0, alpha: 9.8)
    }
}
