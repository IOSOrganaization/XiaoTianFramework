...
class UtilDateTime: NSObject {
    ...
    /// 格式化日期 (秒/s) [1990年1月1日]
    func formatMillisecondDate(_ dateMillisecond: NSNumber?) -> String?{
    ...
    /// 格式化日期 (秒/s) [1月1日]
    func formatDateTime(_ dateMillisecond: NSNumber?) -> String?{
        if dateMillisecond == nil {
            return nil
        }
        // 时间格式化器
    ...
    func formatMillisecondDateTime(_ dateMillisecond: NSNumber?) -> String?{
        if dateMillisecond == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 格式化时间 (秒/s) [23:35:50]
    func formatMillisecondTime(_ dateMillisecond: NSNumber?) -> String?{
        if dateMillisecond == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func formatMillisecond(_ pattern:String,_ dateMillisecond: NSNumber?) -> String?{
        if dateMillisecond == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 格式化为指定时间格式
    func formatDateTime(_ pattern:String,_ date: Date?) -> String?{
        if date == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 时刻(无时区限制)
    func formatFunnyDate(_ dateMillisecond: NSNumber?) -> String?{
        if dateMillisecond == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func pasteStringMillisecond(_ date:String?) -> NSNumber?{
        if date == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 转换NSDate为毫秒
    func pasteDateMillisecond(_ date:Date?) -> NSNumber?{
        if date == nil{
            return nil
        }
    ...
    func pasteDateTimeMillisecond(_ date:String?) -> NSNumber?{
        if date == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func pasteTimeMillisecond(_ date:String?) -> NSNumber?{
        if date == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 转换String格式化的时间为毫秒
    func pasteFormatDateMillisecond(_ pattern:String,_ date:String?) -> NSNumber?{
        if date == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func pasteDateTime(_ dateTime:String?) -> Date?{
        if dateTime == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func pasteDate(_ date:String?) -> Date?{
        if date == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    func pasteTime(_ time:String?) -> Date?{
        if time == nil{
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 转换数字时间为 Date
    func translateToDate(_ dateMillisecond: NSNumber?) -> Date?{
        if dateMillisecond == nil {
            return nil
        }
        let dateFormatter = DateFormatter()
    ...
    /// 获取时间的中文周
    func getChineseWeekDay(_ date: Date?) -> String?{
        if date != nil{
            return nil
        }
    ...
    /// 创建日期(相对于当前时区)
    func createDate(_ year:Int,_ month:Int,_ day:Int,_ hour: Int,_ minute: Int,_ second: Int) -> Date{
        var calander = Calendar.current
        calander.locale = Locale.current
        calander.timeZone = TimeZone.current
