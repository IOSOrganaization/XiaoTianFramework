#
#  Be sure to run `pod spec lint XiaoTianFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "xiaotian" => "gtrstudio@qq.com" }
  # Or just: s.author    = "xiaotian"
  # s.authors            = { "xiaotian" => "gtrstudio@qq.com" }
  # s.social_media_url   = "http://twitter.com/xiaotian"
